...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>[OPTIONAL] Open results file locally.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>

This step is optional, but it is a convenient way to explore the results of the spike sorting job in a Python environment.

You can load the results file to your local machine by clicking on `Load NWB file in Python`, copying the code snippet and running it in your local Python environment.
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>2. Open results file in Neurosift.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>
...
![File info](/img/tutorial_dandi/5_2_open_file_neurosift.png)
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>3. Explore results file data on Neurosift. [part 1]</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>
...
![Neurosift](/img/tutorial_dandi/5_3_open_psth.png)
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>4. Explore results file data on Neurosift. [part 2]</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>
...
![Raster](/img/tutorial_dandi/5_6_raster.png)
