...
At this point, you can take some time to explore the vast number of configuration options for the job.

<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>2. Explore the job configuration options.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>

 Here’s a couple of relevant ones:
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>3. Explore the processor configuration options.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>4. Submit the job.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>

  - Click on `Submit job(s)`.
  - At the `Jobs` page, click on `approve` to start the job.
...
<details>
  <summary>
    <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
        <div>5. Follow the job progress.</div>
        <NonPropagatingCheckbox style={{marginLeft: "auto"}} />
    </span>
  </summary>

You can follow the job's progress in real time.
  - logs
  - resources
